...
\input{Graphs_Figures/OMNI_Graph1.tex}
\input{Graphs_Figures/OMNI_Graph2.tex}
%------------------------------------------------------------------
...
\input{Graphs_Figures/SuperDARN_Figure1.tex}
\input{Graphs_Figures/SuperDARN_Figure2.tex}
%------------------------------------------------------------------
...
\input{Graphs_Figures/Ampere_Figure1.tex}
\input{Graphs_Figures/Ampere_Figure2.tex}
%------------------------------------------------------------------
...
\input{Graphs_Figures/IMAGE_Graph.tex}
%==================================================================
\section{Discussion}
The sequence of events during the 10--11 May 2024 storm follows the classic reconnection-driven picture perfectly.
The sudden arrival of the high-speed coronal mass ejection is clearly visible in Figures~\ref{fig:OMNI1} and \ref{fig:OMNI2}: solar wind speed jumps to almost 1000 km/s and $B_z$ turns strongly southward, reaching $-$25 nT for several hours.
...
At the same time, AMPERE (Figures~\ref{fig:Ampere1} and \ref{fig:Ampere2}) records extreme intensification of both Region 1 and Region 2 currents, with peak upward currents exceeding 3 $\mu$A/m$^2$ in the dusk sector.
...
The nightside response is equally dramatic: the IMAGE electrojet indices (Figure~\ref{fig:IMAGE}) show multiple sharp drops of the AL index to below $-$3000 nT, confirming repeated, very intense substorms.
